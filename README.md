...
GuYue-Admin 一款基于 Vue3.0、TypeScript、Vite3.2、Pinia、Ant Design Vue 开源的后台管理框架，使用目前最新技术栈开发。提供简单基于 antd vue ProTable 组件，在一定程度上节省您的开发效率。另外本项目还封装了一些常用组件、Hooks、指令、动态路由、按钮级别权限控制等功能。
...
![login_light](https://imgtg.com/image/O5xkjc.png)

- 首页：

![home_light](https://imgtg.com/image/O5xno1.png)

- 表格页：

![table_light](https://imgtg.com/image/O5xhsG.png)

- 数据可视化

![dashboard](https://imgtg.com/image/O5xFgM.png)
